after :agencies, :categories, :subsidiaries do
  ...
  cars << Car.new(image: 'peugeot_208', brand: 'PEUGOUT', model: '208', year: 2012, ac: 1, abs: 1, transmission: 1, doors_number: 4, capacity: 5, price: 74, fuel_type: 'diesel', fuel_consumption: 5, is_available: 1, current_subsidiary: 0, agency: a, category: economy)
  cars << Car.new(image: 'peugeot_407', brand: 'PEUGOUT', model: '407', year: 2013, ac: 1, abs: 1, transmission: 1, doors_number: 5, capacity: 5, price: 26, fuel_type: 'diesel', fuel_consumption: 5.9, is_available: 1, current_subsidiary: 0, agency: a, category: standard)
  cars << Car.new(image: 'peugeot_107', brand: 'PEUGOUT', model: '107', year: 2014, ac: 0, abs: 1, transmission: 1, doors_number: 2, capacity: 4, price: 85, fuel_type: 'diesel', fuel_consumption: 4, is_available: 1, current_subsidiary: 0, agency: a, category: economy)
