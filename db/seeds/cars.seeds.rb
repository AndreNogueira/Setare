after :agencies, :categories do
  ...
  cars << Car.new(image:'smart_fortwo',brand:'SMART',model:'ForTwo',year:2009,ac:0,abs:1,transmission:0,doors_number:2,capacity:2,price:52,fuel_type:'diesel',fuel_type:'gasoline',fuel_consumption:3  ,is_available:1,current_subsidiary:0,agency:a,category:economy)
  ...
  puts 'End ------------Budget Cars ------'

  puts 'Begin ------- Dollar Cars ------'
  ...
  puts 'End ------------Dollar Cars ------'


  puts 'Begin ------- Europcar Cars ------'
  ...
  puts 'End ------------Europcar Cars ------'

  puts 'Begin ------- Hertz Cars ------'
  ...
  puts 'End ------------National Cars ------'


  puts 'Begin ------- Thrifty Cars ------'
